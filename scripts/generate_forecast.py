...
def load_envelope(path):
    """Load a JSON file and return its `data` payload.

    Accepts both the new {generated_at, data: ...} envelope and legacy
    payloads where the root is already the data array/object.
    """
...
def generate_forecast():
    ...
    write_json(
        ...
        {'forecast': demand_forecast, 'regression': regression},
    ...
    generate_comments(daily, demand_forecast, regression)
